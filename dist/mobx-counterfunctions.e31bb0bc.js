...
},{"process":"node_modules/process/browser.js"}],"node_modules/mobx-jsx/dist/index.js":[function(require,module,exports) {
"use strict";
...
exports.currentContext = exports.Component = void 0;
...
function memo(fn, equal) {
  ...
  const o = _mobx.observable.box((0, _mobx.untracked)(fn));
...
function createComponent(Comp, props, dynamicKeys) {
  ...
  return (0, _mobx.untracked)(() => Comp(props));
...
function lazy(fn) {
  return props => {
    ...
    const result = _mobx.observable.box();

    fn().then(component => result.set(component.default));
    const rendered = (0, _mobx.computed)(() => (Comp = result.get()) && (0, _mobx.untracked)(() => Comp(props)));
    return () => rendered.get();
  };
} // context api
...
function createProvider(id) {
  return function provider(props) {
    let rendered = _mobx.observable.box();

    effect(() => {
      globalContext.context = {
        [id]: props.value
      };
      rendered.set((0, _mobx.untracked)(() => resolveChildren(props.children)));
    });
    return () => rendered.get();
  };
...
function map(list, mapFn) {
  ...
  return () => {
    list[_mobx.$mobx].atom.reportObserved();
...
const currentContext = {}; // Slightly modified version of: https://github.com/WebReflection/udomdiff/blob/master/index.js
...
function cleanChildren(parent, current, marker, replacement) {
  ...
  if (current.length) {
    ...
    for (let i = current.length - 1; i > 0; i--) current[i].parentNode === parent && parent.removeChild(current[i]);
...
//# sourceMappingURL=/mobx-counterfunctions.e31bb0bc.js.map